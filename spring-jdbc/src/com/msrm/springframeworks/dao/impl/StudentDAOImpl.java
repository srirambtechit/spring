...
public class StudentDAOImpl implements StudentDAO {
	...
	public int save(Student student) {
		String sql = String.format("insert into student (name, address, email) values ('%s', '%s', '%s')",
	...
	public int update(Student student) {
		String sql = String.format("update student set name='%s', address='%s', email='%s' where id='%s'",
				student.getName(), student.getAddress(), student.getEmail(), student.getId());
		System.out.println(sql);
		return jdbcTemplate.update(sql);
	}
